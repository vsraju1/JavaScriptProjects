...
buttons.forEach(function (button) {
  console.log(button);
  button.addEventListener('click', level_button)
})

function level_button(e){
    var level = Number(e.target.id);
    console.log(level);
...
function answer_easy(level) {
  console.log(level)
  random_number = Math.floor((Math.random() * level) + 1);
